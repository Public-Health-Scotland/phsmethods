...
* The final, 10<sup>th</sup>, digit is a (Modulus-11) 'check digit' - This helps guard against transcription errors, for example, if someone makes a typo it is very unlikely that the check digit will still be valid.
...
1. CHI passes Mod-11 and fails Mod-10.
2. CHI passes Mod-11 and passes Mod-10.
3. CHI fails Mod-11 and passes Mod-10.
4. CHI fails Mod-11 and fails Mod-10. 

For scenarios (1), (2) and (4), the CHI check results are no different to previously but allowing scenario (3) to occur means that more CHI numbers will pass a CHI check compared with previously. It is important to note that prior to the implementation date of allowing Mod-10 to be used for CHI numbers, no individuals will have been assigned a CHI number that passes Mod-10 but fails Mod-11.  
