#` @title Assign a date to the correct financial year
#`
...
#`
#` @param date A date which must be supplied in date format, The function
#` as.Date() can be used to change a variable to date format.
